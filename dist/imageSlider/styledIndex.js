...
export var Indicator = styled.div(templateObject_5 || (templateObject_5 = __makeTemplateObject(["\n\twidth: ", "px;\n\theight: ", "px;\n\tborder: 1px solid ", ";\n\tbackground-color: ", ";\n\tborder-radius: 50%;\n\tmargin-inline: 2px;\n\ttransition: 0.3s;\n\ttransform: translateY(calc(", "px / -1));\n\n\tcursor: pointer;\n\n\t&:hover {\n\t\t", ";\n\t}\n"], ["\n\twidth: ", "px;\n\theight: ", "px;\n\tborder: 1px solid ", ";\n\tbackground-color: ", ";\n\tborder-radius: 50%;\n\tmargin-inline: 2px;\n\ttransition: 0.3s;\n\ttransform: translateY(calc(", "px / -1));\n\n\tcursor: pointer;\n\n\t&:hover {\n\t\t", ";\n\t}\n"])), function (props) { return props.$dotSize; }, function (props) { return props.$dotSize; }, function (props) { return props.$dotBorderColor; }, function (props) { return props.$dotColor; }, function (props) { return props.$dotSize; }, function (props) {
    return props.$hoverFlag && "background-color:  ".concat(props.$dotHoverColor);
});
